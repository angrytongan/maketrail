...
- [ ] Trail marking — click a sequence of waypoints, Bezier-style tangent handles, rendered in 3D as a colored ribbon draped on the terrain surface (not a floating spline). See decisions.md "Trail marking".
